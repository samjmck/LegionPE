 ...
 * Mobile navbar
 */
var mainOverlayElement = document.getElementById('main-overlay');
var mobileNavbarElement = document.getElementById('mobile-navbar');
var openMobileNavbarUnderlineElement = document.getElementById('open-mobile-navbar').getElementsByClassName('underline')[0];

document.getElementById('open-mobile-navbar').addEventListener('click', function(){
	openMobileNavigationMenu();
});
document.getElementById('close-mobile-navbar').addEventListener('click', function(){
	closeMobileNavigationMenu();
});

function openMobileNavigationMenu(){
	openMobileNavbarUnderlineElement.className = 'underline selected';
	mainOverlayElement.className = 'overlay dark';
	mobileNavbarElement.className = 'showing';
}
function closeMobileNavigationMenu(){
	openMobileNavbarUnderlineElement.className = 'underline';
	mainOverlayElement.className = 'overlay';
	mobileNavbarElement.className = '';
}
